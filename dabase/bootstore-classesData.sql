...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 19, 2019 at 03:01 PM
...
INSERT INTO `items` (`id`, `title`, `image`, `mimeType`, `description`, `conditionofused`, `author`, `ISBN`, `price`, `DeweyDecimalClass`, `type1`, `type2`, `type3`, `sellerId`, `isFrontPage`) VALUES
(2, 'Think in php', '', '', '', 100, 'php', '1234656456', '9.99', 'php', 'programming', '', '', 2, 0);
