...
(4, 1, 15, 'eq273fnlvc7c5lff8cs02vgvm5', '2019-01-21 04:11:40'),
(5, 1, 15, 'eq273fnlvc7c5lff8cs02vgvm5', '2019-01-21 04:12:49'),
(6, 1, 15, 'eq273fnlvc7c5lff8cs02vgvm5', '2019-01-21 04:12:59');
...
('396', 'No longer used—formerly Women position and treatment'),
...
CREATE TABLE `items` (
  ...
  `conditionofused` int(3) NOT NULL DEFAULT '80',
  `author` varchar(100) NOT NULL,
  `ISBN` varchar(30) NOT NULL,
  `price` decimal(5,2) NOT NULL,
  `DeweyDecimalClass` varchar(3) NOT NULL,
  `type1` varchar(100) NOT NULL,
  `type2` varchar(100) NOT NULL,
  `type3` varchar(100) NOT NULL,
  `sellerId` int(11) NOT NULL,
  `isFrontPage` tinyint(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `users` (`id`, `joinedOn`, `email`, `password`, `isAdmin`) VALUES
(1, '2019-01-21 04:11:08', 'jerry@j.r', '', 0);
